...
const FavorSubwayArrivalInfoCp = ({ route, navigation } : any) => {
    ...
    useEffect(() => {
         const lineList = function () {
                 ...
                 const subWaySearch = async function(lineList : any) {
                        return await new Promise( resolve => { AxiosCall("GET", `http://swopenapi.seoul.go.kr/api/subway/576e49415564627733364f744f5166/json/realtimeStationArrival/0/100/${statNm}`, null, function (data) {
    ...
    return (
         arvalInfo && <SubWayInfo arvalInfo={arvalInfo} ></SubWayInfo>
    )
}

const FavorSubwayArrivalInfo = React.memo(FavorSubwayArrivalInfoCp);
export default FavorSubwayArrivalInfo;